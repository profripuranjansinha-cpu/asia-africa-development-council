...
export class Backend implements backendInterface {
    ...
    async addEvent(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
    ...
    async initializeContent(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeContent(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: InquiryType): Promise<Inquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, arg2, arg3, to_candid_InquiryType_n6(this._uploadFile, this._downloadFile, arg4));
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "donation" in value ? InquiryType.donation : "collaboration" in value ? InquiryType.collaboration : "membership" in value ? InquiryType.membership : "general" in value ? InquiryType.general : value;
}
...
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: InquiryType): {
    ...
    return value == InquiryType.donation ? {
        donation: null
